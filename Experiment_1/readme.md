...
🧪 Methodology
Selected vulnerable C and Python programs for analysis
Conducted manual code inspection to identify unsafe functions
Used static analysis techniques/tools to detect security issues
Identified and categorized different types of vulnerabilities
Compared insecure code with secure coding practices
⚙️ Tools Used
